...
GLint flag = 0, flag1 = 0, flag2 = 0, flag3 = 0, flag4 = 0, flag5 = 1;
GLfloat sp1 = 0.007, sp2 = 0.01, sp3 = 0.05;
void init()
{
...
void screen()
{
	...
	char a[] = "CG MINI PROJECT ON-AEROPLANE";
	drawstring(210, 540, 0.0,a);
	char b[] = "CREATED BY:";
	drawstring(260, 500, 0.0, b);
	glColor3f(1.0, 1.0, 1.2);
	char c[] = "ANMOLDEEP SINGH";
	drawstring(180, 420, 0.0, c);
	char d[] = "101903083";
	drawstring(340, 420, 0,d);
	
	char i[] = "THAPAR INSTITUTE OF ENGINEERING AND TECHNOLOGY";
	drawstring(160, 240, 0.0, i);
	glColor3f(0.0, 0.8, 1.0);
	char j[] = "DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING";
	drawstring(160, 130, 0.0, j);
	char k[] = "ACADEMIC YEAR: 2021-22";
	drawstring(230, 80, 0.0, k);
	glColor3f(rand() % 2, rand() % 3, rand() % 2);
	char l[] = "Press 'a' to start the game";
	drawstring(245, 35, 0.0, l);
	glFlush();
}
void msg()
{
	glColor3f(1.0, 0.2, 0.0);
	char m[] = "CONGRATULATIONS";
	drawstring(250, 300, 0.0, m);
	char n[] = "LEVEL COMPLETED";
	drawstring(250, 250, 0.0, n);
	char o[] = "Press 'L' to start Next Level";
	drawstring(250, 200, 0.0, o);
}
void msg1()
{
	glColor3f(1.0, 0.6, 0.6);
	char p[] = "GAME OVER RETRY";
	drawstring(250, 300, 0.0, p);
	char q[] = "PRESS 'e' TO EXIT";
	drawstring(250, 270, 0.0, q);
}
void msg2()
{
	glColor3f(1.0, 0.6, 0.6);
	char r[] = "GAME OVER";
	drawstring(250, 320, 0.0, r);
	char s[] = "Player completed 1 level";
	drawstring(250, 280, 0.0, s);
	char t[] = "PRESS 'e' TO EXIT";
	drawstring(250, 250, 0.0, t);
}
void msg3()
{
	glColor3f(1.0, 0.6, 0.6);
	char u[] = "GAME OVER";
	drawstring(250, 320, 0.0, u);
	char v[] = "Player completed 2 level";
	drawstring(250, 280, 0.0, v);
	char w[] = "PRESS 'e' TO EXIT";
	drawstring(250, 250, 0.0,w);
}
...
void obstacle()
{
	...
	glVertex2f(x19, y20);
	glEnd();
	glColor3f(rand() % 200, rand() % 100, rand() % 50);
	glBegin(GL_POLYGON);
	glVertex2f(x21, y21);
	glVertex2f(x22, y21);
	glVertex2f(x22, y22);
...
{	//PLANE MOV
	if (flag1 == 1)
	{
		...
		if (a >= 600) //upon completion of a particular level
		{
			sp3 = sp3 + 0.03125;
			sp1 = sp1 + 0.05;
			sp2 = sp2 + 0.06;
...
void display(void)
{
	...
	if (flag2 == 1 && sp1 >= 0.007 && sp1 < 0.01)
	{
		flag1 = 0;
		msg1();
	}
	else if (flag2 == 1 && sp2 >= 0.01 && sp2<0.05)
	{
		flag1 = 0;
		msg2();
	}
	else if (flag2 == 1 && sp3 >= 0.05)
	{
		flag1 = 0;
		msg3();
	}
	...
	if (flag4 == 1)
	{
		...
		flag5 = 1;
		char x[] = "Congrats";
		drawstring(250, 330, 0.0, x);
		char y[] = "Player Completes All 3 Levels";
		drawstring(210, 300, 0.0, y);
	}
	glFlush();
